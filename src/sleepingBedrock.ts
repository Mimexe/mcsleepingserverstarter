...
// import ServerSocket from "@jsprismarine/raknet/dist/ServerSocket.js";
// import PlayerConnectEvent from "@jsprismarine/prismarine/dist/events/player/PlayerConnectEvent";
// import {EventManager} from "@jsprismarine/prismarine/dist/events/EventManager";
...
export class SleepingBedrock implements ISleepingServer {
  ...
  constructor(
    ...
    // this.serverSocket = new ServerSocket(settings.maxPlayers, settings.serverOnlineMode)
    //
  ...
  init = async () => {
    ...
    // this.serverSocket.start(Address, this.settings.bedrockPort)
    ...
    // this.eventManager.on("playerConnect", this.handlePlayerConnect);
  };
  ...
  //
  // private handlePlayerConnect(playerConnect: PlayerConnectEvent) {
  //   this.logger.info(`[BedRock] PlayerConnectEvent ${playerConnect}`);
  //
  // }
}
